    ...
    <>
      <div className="w-[1440px] m-auto  ">
        <div className="w-[1310px] m-auto  mt-[85px] flex items-start justify-between">
          ...
          {svar.length === 0 && <Empty_like_component />}
        </div>
        {svar.length > 0 && (
