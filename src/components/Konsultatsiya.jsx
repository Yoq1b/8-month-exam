    ...
    <>
      <div className="w-[1440px] m-auto mt-[150px]">
        <div className="w-[1310px] m-auto flex items-start justify-between">
          <div>
            <h4 className="text-[#202020] mb-[25px] text-[30px] leading-[36px] font-semibold">
            ...
            <p className="text-[#202020] font-medium text-[16px] leading-[22.4px]">
              ...
              или оставьте
              <br /> свои координаты и наш менеджер перезвонит вам через 10
              минут
            </p>
          </div>
          <div className="w-[650px] h-[445px] relative rounded-[10px] px-[40px] pt-[35px] bg-[#FFFFFF] border border-[#E5E2EE]">
            <input
              type="text"
