...
const Telefon_modal = ({ handlevoyti }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="w-[500px] relative h-[200px] rounded-[10px] bg-white px-[25px]">
        <div className="flex mt-[20px] items-center justify-between">
          <p className="text-[#202020] text-[18px] font-semibold">Телефон</p>
          <IoClose
        ...
        <p className="text-[14px] mt-[5px] text-center font-medium text-red-600">
          Код страны будет введен автоматически (+998).
        </p>
        <div className="flex items-center mt-[15px] gap-[15px]">
          <button
            onClick={handleOpenModal}
            className="w-[274px] capitalize m-auto h-[41px] rounded-[50px] bg-[#088269] text-[#F8F7F3] text-[16px] font-semibold hover:scale-105 duration-200 hover:bg-[#07745E]"
          >
            сохранить
          </button>
        </div>
